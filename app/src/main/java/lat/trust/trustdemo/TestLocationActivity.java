...
public class TestLocationActivity extends AppCompatActivity {
    ...
    public void toggleGPSUpdates(View view) {
        ...
        if (button.getText().equals(getResources().getString(R.string.pause))) {
            ...
            locationManager.requestLocationUpdates(
                    LocationManager.GPS_PROVIDER, 2000, 10, locationListenerGPS);
    ...
    public void toggleBestUpdates(View view) {
        ...
        if (button.getText().equals(getResources().getString(R.string.pause))) {
            ...
            if (provider != null) {
                locationManager.requestLocationUpdates(provider, 2000, 10, locationListenerBest);
                button.setText(R.string.pause);
    ...
    public void toggleNetworkUpdates(View view) {
        ...
        if (button.getText().equals(getResources().getString(R.string.pause))) {
            ...
            locationManager.requestLocationUpdates(
                    LocationManager.NETWORK_PROVIDER, 2000, 5, locationListenerNetwork);
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(TestLocationActivity.this, "Best Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(TestLocationActivity.this, "Network Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(TestLocationActivity.this, "GPS Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        @Override
